...
bbp_capita_long.head()


# In[4]:


#fig1 = px.line(bbp_capita_long, x='Jaar', y='BBP', color='Land', title='Bruto Binnenlands Product per inwoner per land')
#fig1.update_xaxes(title_text="Jaar")
#fig1.update_yaxes(title_text="BBP per inwoner (x €1000)")
...
#px.histogram(welvaart, x='Totaal gemiddeld persoonlijk inkomen', nbins=20)


# In[10]:


#welvaart.loc[welvaart['Totaal gemiddeld persoonlijk inkomen'] <13]
...
#fig9 = px.scatter(samen, y='BBP', x='Gemiddeld_inkomen', trendline='ols', title='Spreiding gemiddelde inkomen tegen het BBP per inwoner')
#fig9.update_xaxes(title_text="Gemiddeld inkomen per inwoner (x €1000)")
#fig9.update_yaxes(title_text="BBP per inwoner (x €1000)")
...
#data_arbeid = pd.DataFrame(cbsodata.get_data('80590ned'))

#data_arbeid = data_arbeid[['Geslacht', 'Leeftijd', 'Perioden', 'Seizoengecorrigeerd_2', 'Seizoengecorrigeerd_4', 'Seizoengecorrigeerd_6', 'Seizoengecorrigeerd_8', 'Seizoengecorrigeerd_10', 'Seizoengecorrigeerd_12', 'Seizoengecorrigeerd_14']]

#data_arbeid.columns = ['Geslacht', 'Leeftijd', 'Perioden', 'Beroepsbevolking', 'werkzame_beroepsbevolking', 'werkloze_beroepsbevolking', 'Werkloosheidspercentage', 'niet-beroepsbevolking', 'bruto_arbeidsparticipatie', 'netto_arbeidsparticipatie']

#value_list = ['2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018', '2019','2020', '2021', '2022']

#boolean_series = data_arbeid.Perioden.isin(value_list)
#data_arbeid = data_arbeid[boolean_series]
...
#df_inflatie = pd.read_csv('inflatie.csv',sep=";",  decimal=',')
#df_inflatie
...
fig = px.line(df_inflatie2, x='Perioden', y = 'CPI')
...
#inflatie_jaren['Jaar'] = pd.to_datetime(inflatie_jaren['Jaar']).dt.year
inflatie_jaren.head()
...
#geo_df.info()
#df1['Aantal vacatures'] = pd.to_numeric(df1['Aantal vacatures'], downcast="float")
...
bedrijven = pd.read_csv('Aantal bedrijven naar omvang (1).csv', sep=";",  decimal=',')
bedrijven = bedrijven.melt(id_vars = ['Perioden'], value_name = 'Aantal', var_name = 'Omvang')
bedrijven2 = bedrijven.loc[bedrijven.Perioden == '2021 Vierde kwartaal']
bedrijven.head()
...
fig = px.histogram(bedrijven, x='Omvang', y='Aantal', color='Omvang')


# In[50]:


fig = px.bar(bedrijven, x='Perioden', y='Aantal', color='Omvang')
...
{'label': "1 werkzaam persoon"           , 'method': "update", 'args': [{"visible": [False,True,False,False,False,False,False,False,False,False]}, {'title': "1 werkzaam persoon"}]},
{'label': "3 tot 5 werkzame personen"    , 'method': "update", 'args': [{"visible": [False,False,True,False,False,False,False,False,False,False]}, {'title': "3 tot 5 werkzame personen"}]},
{'label': "5 tot 10 werkzame personen"   , 'method': "update", 'args': [{"visible": [False,False,False,True,False,False,False,False,False,False]}, {'title': '5 tot 10 werkzame personen'}]},
{'label': "10 tot 20 werkzame personen"  , 'method': "update", 'args': [{"visible": [False,False,False,False,True,False,False,False,False,False]}, {'title': "10 tot 20 werkzame personen"}]},
{'label': "20 tot 50 werkzame personen"  , 'method': "update", 'args': [{"visible": [False,False,False,False,False,True,False,False,False,False]}, {'title': "20 tot 50 werkzame personen"}]},
{'label': "50 tot 100 werkzame personen" , 'method': "update", 'args': [{"visible": [False,False,False,False,False,False,True,False,False,False]}, {'title': '50 tot 100 werkzame personen'}]},
{'label': "100 of meer werkzame personen", 'method': "update", 'args': [{"visible": [False,False,False,False,False,False,False,True,False,False]}, {'title': "100 of meer werkzame personen"}]},
...
woning_wide = woning.pivot(index='Jaar', columns="Regio's", values=['Prijs'])

woning_wide.reset_index().head()


# In[56]:


#px.line(woning_wide, x=woning_wide.index, y=woning.Prijs['Drenthe'])
